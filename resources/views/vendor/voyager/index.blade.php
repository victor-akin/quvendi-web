...
@section('content')
    <div class="page-content">
        ...
        <div class="col-sm-12 dashboard-quick-links">
            <div class="quick-link-cards">
                <a href="admin/users/create" class="col-sm-2 quick-link-card">Add User</a>
                <a href="admin/users"" class="col-sm-2 quick-link-card">Edit User</a>
                <a href="admin/users" class="col-sm-2 quick-link-card">Suspend User</a>
                <a href="admin/users" class="col-sm-2 quick-link-card">Delete User</a>
                
                <a href="admin/merchants/create" class="col-sm-2 quick-link-card">Add Merchant</a>
                <a href="admin/merchants" class="col-sm-2 quick-link-card">Edit Merchant</a>
                <a href="admin/merchants" class="col-sm-2 quick-link-card">Suspend Merchant</a>

                <a href="admin/transactions" class="col-sm-2 quick-link-card">View Transactions</a>
            </div>
        </div>
        ...
        <div class="analytics-container">
            ...
            <div class="col-sm-12" style="margin-top:30px;">
                <div class="col-sm-12 quvendi-analytics-container">
                    <ul class="FlexGrid FlexGrid--halves">
                        <li class="flex-item col-sm-4">
                            <div class="Chartjs-display">
                                <header class="Titles">
                                    <h1 class="Titles-main">New users that registered today</h1>
                                    <hr>
                                </header>
                                <div class="new-users">0</div>
                                <span></span>
                            </div>
                        </li>
                        <li class="flex-item col-sm-4">
                            <div class="Chartjs-display">
                                <header class="Titles">
                                    <h1 class="Titles-main">Completed transactions today</h1>
                                    <hr>
                                </header>
                                <div class="num-transactions">0</div>
                                <span></span>
                            </div>
                        </li>
                        <li class="flex-item col-sm-4">
                            <div class="Chartjs-display">
                                <header class="Titles">
                                    <h1 class="Titles-main">Total Revenue from transactions today</h1>
                                    <hr>
                                </header>
                                <div class="amt-transactions">₦0.00</div>
                                <span></span>
                            </div>
                        </li>
                    </ul>
                    <ul class="FlexGrid analytics-chart">
                        <li class="FlexGrid-item">
                            <div class="Chartjs">
                                <header class="Titles">
                                    <h1 class="Titles-main chart-title">TRANSACTION TREND DURING THE YEAR</h1>
                                    <div class="Titles-sub"></div>
                                </header>
                                <figure class="Chartjs" id="transaction-trend" style="height:500px;"></figure>
                                <ol class="Chartjs-legend-transaction-trend" id="legend-transaction-trend"></ol>
                            </div>
                        </li>
                    </ul>
                </div>
...
@section('javascript')
    ...
    <script>
        ...
        let ctx = makeCanvas('transaction-trend')
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointBorderColor: 'rgba(119,136,153 ,1)',
                    label: 'Average revenue in a month',
                    data: [12, 19, 3, 5, 2, 330],
